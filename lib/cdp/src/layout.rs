use cdp_protocol::cdp::browser_protocol::dom::Quad;
use cdp_protocol::cdp::browser_protocol::input::{
    DispatchMouseEventParams, DispatchMouseEventType, MouseButton,
};
use cdp_protocol::cdp::browser_protocol::page::Viewport;
