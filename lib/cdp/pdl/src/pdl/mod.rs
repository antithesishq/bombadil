...
pub struct Version {
    #[cfg_attr(
        feature = "serde",
        serde(serialize_with = "ser::serialize_usize")
    )]
    pub major: usize,
    #[cfg_attr(
        feature = "serde",
...
pub struct Domain<'a> {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(skip_serializing_if = "ser::is_false")
    )]
...
pub enum Item<'a> {
    #[cfg_attr(
        feature = "serde",
        serde(serialize_with = "ser::serialize_enum")
    )]
    Enum(Vec<Variant<'a>>),
...
pub struct Command<'a> {
    ...
    #[cfg_attr(
        feature = "serde",
        serde(serialize_with = "ser::serialize_redirect")
    )]
