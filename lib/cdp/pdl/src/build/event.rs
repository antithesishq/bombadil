...
impl<'a> EventBuilder<'a> {
    ...
    pub fn build(self) -> TokenStream {
        ...
        for event in &self.events {
            ...
            let domain_mod =
                format_ident!("{}", event.domain.name.to_snake_case());
            ...
            let (
                variant_match,
                into_event,
                consume_event_macro_expr,
                event_as_boxed_result,
            ) = if event.needs_box {
                (
                    quote! {
        ...
        let event_impl = quote! {
            ...
            pub struct CdpEventMessage {
                /// Name of the method
                pub method: cdp_types::MethodId,
                /// The chromium session Id
                pub session_id: Option<String>,
                /// Json params
                pub params: CdpEvent,
            }
            impl cdp_types::Method for CdpEventMessage {
            ...
            impl cdp_types::EventMessage for CdpEventMessage {
        ...
        let deserialize_impl = quote! {
            ...
            impl std::convert::TryInto<cdp_types::CdpJsonEventMessage> for CdpEventMessage {
                type Error = serde_json::Error;

                fn try_into(self) -> Result<cdp_types::CdpJsonEventMessage, Self::Error> {
