...
, stdenv ? pkgs.stdenv, buildRustCrateForPkgs ? pkgs:
  pkgs.buildRustCrate
...
rec {
  ...
  workspaceMembers = {
    "bombadil" = rec {
      packageId = "bombadil";
      build = internal.buildRustCrateWithFeatures { packageId = "bombadil"; };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-tungstenite" = rec {
        ...
        features = {
          ...
          "tokio-rustls-native-certs" =
            [ "__rustls-tls" "rustls-native-certs" ];
      ...
      "atomic-waker" = rec {
        ...
        features = { "portable-atomic" = [ "dep:portable-atomic" ]; };
      };
      "autocfg" = rec {
        crateName = "autocfg";
        version = "1.5.0";
      ...
      "axum" = rec {
        ...
        devDependencies = [
          ...
          }
          {
            ...
            rename = "tower";
            features =
              [ "util" "timeout" "limit" "load-shed" "steer" "filter" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
        ...
        dependencies = [
          {
            ...
            target = { target, features }:
              (!((target."windows" or false) && ("msvc" == target."env" or null)
          ...
          }
          {
            ...
            target = { target, features }:
              (!((target."windows" or false) && ("msvc" == target."env" or null)
                && (!("uwp" == target."vendor" or null))));
            features =
              [ "read_core" "elf" "macho" "pe" "xcoff" "unaligned" "archive" ];
          }
          {
            name = "rustc-demangle";
      ...
      "chromiumoxide" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            optional = true;
            features =
              [ "rt" "rt-multi-thread" "time" "fs" "macros" "process" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
        ...
        features = {
          "_fetcher-native-async-std" =
            [ "fetcher" "chromiumoxide_fetcher/_native-async-std" ];
          "_fetcher-native-tokio" =
            [ "fetcher" "chromiumoxide_fetcher/_native-tokio" ];
          "_fetcher-rustls-async-std" =
            [ "fetcher" "chromiumoxide_fetcher/_rustls-async-std" ];
          "_fetcher-rustls-tokio" =
            [ "fetcher" "chromiumoxide_fetcher/_rustls-tokio" ];
          "async-std" = [ "dep:async-std" ];
          "async-std-runtime" =
            [ "async-std" "async-tungstenite/async-std-runtime" ];
          "bytes" = [ "dep:bytes" ];
      ...
      "clap" = rec {
        ...
        features = {
          ...
          "deprecated" =
            [ "clap_builder/deprecated" "clap_derive?/deprecated" ];
      ...
      "clap_builder" = rec {
        ...
        features = {
          ...
          "unstable-doc" =
            [ "cargo" "wrap_help" "env" "unicode" "string" "unstable-ext" ];
          "unstable-styles" = [ "color" ];
          "unstable-v5" = [ "deprecated" ];
          "wrap_help" = [ "help" "dep:terminal_size" ];
        };
        resolvedDefaultFeatures =
          [ "color" "error-context" "help" "std" "suggestions" "usage" ];
      };
      "clap_derive" = rec {
      ...
      "cpufeatures" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            target = { target, features }:
              (("loongarch64" == target."arch" or null)
                && ("linux" == target."os" or null));
          }
        ];
      ...
      "digest" = rec {
        ...
        resolvedDefaultFeatures =
          [ "alloc" "block-buffer" "core-api" "default" "std" ];
      };
      "displaydoc" = rec {
      ...
      "env_logger" = rec {
        ...
        resolvedDefaultFeatures =
          [ "auto-color" "color" "default" "humantime" "regex" ];
      };
      "equivalent" = rec {
      ...
      "getrandom" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            target = { target, features }:
              (("uefi" == target."os" or null)
                && ("efi_rng" == target."getrandom_backend" or null));
          }
          {
            name = "wasi";
      ...
      "gimli" = rec {
        ...
        features = {
          ...
          "rustc-dep-of-std" =
            [ "dep:core" "dep:alloc" "dep:compiler_builtins" ];
      ...
      "hashbrown 0.15.5" = rec {
        ...
        features = {
          ...
          "rayon" = [ "dep:rayon" ];
          "rustc-dep-of-std" =
            [ "nightly" "core" "alloc" "rustc-internal-api" ];
          "serde" = [ "dep:serde" ];
        };
        resolvedDefaultFeatures =
          [ "allocator-api2" "default-hasher" "inline-more" ];
      };
      ...
      "html5ever" = rec {
        ...
        features = { "serde" = [ "markup5ever/serde" ]; };
      };
      "http" = rec {
        crateName = "http";
        version = "1.4.0";
      ...
      "hyper-util" = rec {
        ...
        features = {
          ...
          "client-proxy" =
            [ "client" "dep:base64" "dep:ipnet" "dep:percent-encoding" ];
          "client-proxy-system" =
            [ "dep:system-configuration" "dep:windows-registry" ];
          "full" = [
            "client"
            "client-legacy"
            "client-pool"
      ...
      "icu_collections" = rec {
        ...
        features = {
          ...
          "serde" =
            [ "dep:serde" "zerovec/serde" "potential_utf/serde" "alloc" ];
        };
      };
      "icu_locale_core" = rec {
      ...
      "idna_adapter" = rec {
        ...
        features = {
          "compiled_data" =
            [ "icu_normalizer/compiled_data" "icu_properties/compiled_data" ];
        };
        resolvedDefaultFeatures = [ "compiled_data" ];
      };
      "include_dir" = rec {
      ...
      "linux-raw-sys" = rec {
        ...
        resolvedDefaultFeatures =
          [ "auxvec" "elf" "errno" "general" "ioctl" "no_std" ];
      };
      "litemap" = rec {
        crateName = "litemap";
        version = "0.8.1";
      ...
      "markup5ever" = rec {
        ...
        features = { "serde" = [ "web_atoms/serde" ]; };
      };
      "matchers" = rec {
        crateName = "matchers";
        version = "0.2.0";
        ...
        features = { "unicode" = [ "regex-automata/unicode" ]; };
      };
      "matchit" = rec {
        crateName = "matchit";
        version = "0.8.4";
      ...
      "object" = rec {
        ...
        features = {
          ...
          "rustc-dep-of-std" =
            [ "core" "compiler_builtins" "alloc" "memchr/rustc-dep-of-std" ];
          "std" = [ "memchr/std" ];
      ...
      "oxc" = rec {
        ...
        features = {
          ...
          "regular_expression" =
            [ "oxc_regular_expression" "oxc_parser/regular_expression" ];
        ...
        resolvedDefaultFeatures =
          [ "default" "oxc_regular_expression" "regular_expression" ];
      };
      "oxc-miette" = rec {
      ...
      "oxc_ast_macros" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            usesDefaultFeatures = false;
            features =
              [ "full" "parsing" "printing" "proc-macro" "clone-impls" ];
          }
        ];
      ...
      "oxc_estree" = rec {
        ...
        features = {
          "serialize" =
            [ "dep:oxc_data_structures" "dep:itoa" "dep:dragonbox_ecma" ];
        };
        resolvedDefaultFeatures = [ "default" ];
      };
      "oxc_index" = rec {
      ...
      "oxc_sourcemap" = rec {
        ...
        version = "4.2.1";
        edition = "2024";
        sha256 = "1vw60mv37i1lpkmlvaajjd5mwibarmg3jll5mmac06lh4l7jizq5";
        type = [ "lib" "cdylib" ];
        authors = [ "Boshen <boshenc@gmail.com>" ];
        dependencies = [
          {
      ...
      "oxc_span" = rec {
        ...
        features = {
          "schemars" = [ "dep:schemars" ];
          "serialize" =
            [ "compact_str/serde" "dep:serde" "oxc_estree/serialize" ];
        };
        resolvedDefaultFeatures = [ "default" ];
      };
      "oxc_syntax" = rec {
      ...
      "phf_generator 0.12.1" = rec {
        ...
        features = { "criterion" = [ "dep:criterion" ]; };
      };
      ...
      "regex" = rec {
        ...
        features = {
          ...
          "perf-literal" =
            [ "dep:aho-corasick" "dep:memchr" "regex-automata/perf-literal" ];
          ...
          "unicode-gencat" =
            [ "regex-automata/unicode-gencat" "regex-syntax/unicode-gencat" ];
          "unicode-perl" = [
          ...
          "unicode-script" =
            [ "regex-automata/unicode-script" "regex-syntax/unicode-script" ];
          "unicode-segment" =
            [ "regex-automata/unicode-segment" "regex-syntax/unicode-segment" ];
          "unstable" = [ "pattern" ];
          "use_std" = [ "std" ];
        };
        resolvedDefaultFeatures = [
      ...
      "regex-automata" = rec {
        ...
        features = {
          ...
          "perf-literal" =
            [ "perf-literal-substring" "perf-literal-multisubstring" ];
          "perf-literal-multisubstring" = [ "dep:aho-corasick" ];
          "perf-literal-substring" =
            [ "aho-corasick?/perf-literal" "dep:memchr" ];
          "std" =
            [ "regex-syntax?/std" "memchr?/std" "aho-corasick?/std" "alloc" ];
      ...
      "reqwest" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            target = { target, features }:
              (!("wasm32" == target."arch" or null));
            features =
              [ "http1" "client" "client-legacy" "client-proxy" "tokio" ];
          }
          {
            name = "js-sys";
            packageId = "js-sys";
        ...
        features = {
          "__rustls" =
            [ "dep:hyper-rustls" "dep:tokio-rustls" "dep:rustls" "__tls" ];
          "__rustls-ring" = [
            "hyper-rustls?/ring"
            "tokio-rustls?/ring"
            "rustls?/ring"
          ...
          "http2" =
            [ "h2" "hyper/http2" "hyper-util/http2" "hyper-rustls?/http2" ];
          "http3" = [
          ...
          "native-tls-alpn" =
            [ "native-tls" "native-tls-crate?/alpn" "hyper-tls?/alpn" ];
          "native-tls-vendored" = [ "native-tls" "native-tls-crate?/vendored" ];
          "rustls-tls" = [ "rustls-tls-webpki-roots" ];
          "rustls-tls-manual-roots" =
            [ "rustls-tls-manual-roots-no-provider" "__rustls-ring" ];
          "rustls-tls-manual-roots-no-provider" = [ "__rustls" ];
          "rustls-tls-native-roots" =
            [ "rustls-tls-native-roots-no-provider" "__rustls-ring" ];
          ...
          "rustls-tls-webpki-roots" =
            [ "rustls-tls-webpki-roots-no-provider" "__rustls-ring" ];
          "rustls-tls-webpki-roots-no-provider" =
            [ "dep:webpki-roots" "hyper-rustls?/webpki-tokio" "__rustls" ];
          "stream" = [
            "tokio/fs"
            "dep:futures-util"
            "dep:tokio-util"
            ...
            target = { target, features }:
              ((!(target."rustix_use_libc" or false))
                ...
                && (("little" == target."endian" or null)
                  || (("s390x" == target."arch" or null)
                    || ("powerpc" == target."arch" or null)))
                && (("arm" == target."arch" or null)
                  || (("aarch64" == target."arch" or null)
                    && ("64" == target."pointer_width" or null))
                  || ("riscv64" == target."arch" or null)
                  || ((target."rustix_use_experimental_asm" or false)
                    && ("powerpc" == target."arch" or null))
                  || ((target."rustix_use_experimental_asm" or false)
                  ...
                  || ((target."rustix_use_experimental_asm" or false)
                    && ("mips32r6" == target."arch" or null))
                  || ((target."rustix_use_experimental_asm" or false)
                    && ("mips64" == target."arch" or null))
                  || ((target."rustix_use_experimental_asm" or false)
                    && ("mips64r6" == target."arch" or null))
      ...
      "serde" = rec {
        ...
        resolvedDefaultFeatures =
          [ "alloc" "default" "derive" "serde_derive" "std" ];
      };
      "serde_core" = rec {
      ...
      "similar" = rec {
        ...
        features = {
          ...
          "serde" = [ "dep:serde" ];
          "unicode" =
            [ "text" "unicode-segmentation" "bstr?/unicode" "bstr?/std" ];
          "unicode-segmentation" = [ "dep:unicode-segmentation" ];
      ...
      "tendril" = rec {
        ...
        features = { "encoding_rs" = [ "dep:encoding_rs" ]; };
      };
      "textwrap" = rec {
        crateName = "textwrap";
        version = "0.16.2";
      ...
      "tokio" = rec {
        ...
        features = {
          ...
          "io-uring" =
            [ "dep:io-uring" "libc" "mio/os-poll" "mio/os-ext" "dep:slab" ];
          "io-util" = [ "bytes" ];
          "libc" = [ "dep:libc" ];
          "macros" = [ "tokio-macros" ];
          "mio" = [ "dep:mio" ];
      ...
      "tower" = rec {
        ...
        features = {
          ...
          "buffer" =
            [ "__common" "tokio/sync" "tokio/rt" "tokio-util" "tracing" ];
          "discover" = [ "__common" ];
          ...
          "indexmap" = [ "dep:indexmap" ];
          "limit" =
            [ "__common" "tokio/time" "tokio/sync" "tokio-util" "tracing" ];
          ...
          "tracing" = [ "dep:tracing" ];
          "util" =
            [ "__common" "futures-util" "pin-project-lite" "sync_wrapper" ];
        };
        resolvedDefaultFeatures = [
          "__common"
          "futures-core"
      ...
      "tower-http" = rec {
        ...
        features = {
          ...
          "follow-redirect" =
            [ "futures-util" "dep:http-body" "iri-string" "tower/util" ];
          "fs" = [
            "futures-core"
            "futures-util"
            "dep:http-body"
      ...
      "unicode-id-start" = rec {
        ...
        authors =
          [ "David Tolnay <dtolnay@gmail.com>" "Boshen <boshenc@gmail.com>" ];
      ...
      "wasip2" = rec {
        ...
        features = {
          ...
          "rustc-dep-of-std" =
            [ "core" "alloc" "wit-bindgen/rustc-dep-of-std" ];
        };
      };
      "wasm-bindgen" = rec {
      ...
      "web_atoms" = rec {
        ...
        features = { "serde" = [ "string_cache/serde_support" ]; };
      };
      "which" = rec {
        crateName = "which";
        version = "8.0.0";
        ...
        dependencies = [
          {
            ...
            optional = true;
            target = { target, features }:
              ((target."windows" or false) || (target."unix" or false)
                || ("redox" == target."os" or null));
          }
          {
            name = "rustix";
    ...
    */
    builtRustCratesWithFeatures = { packageId, features, crateConfigs ? crates
      , buildRustCrateForPkgsFunc, runTests, makeTarget ? makeDefaultTarget
      }@args:
      ...
      let
        ...
        buildByPackageIdForPkgsImpl = self: pkgs: packageId:
          let
            ...
            in lib.filter (d: d ? "rename") (hostDeps ++ buildDeps);
            ...
            in lib.mapAttrs (name: builtins.map versionAndRename) grouped;
    ...
    */
    ...
    doesFeatureEnableDependency = dependency: feature:
      ...
      in feature == name || feature == "dep:" + name || startsWithPrefix;
      ...
      let
        expandFeaturesNoCycle = oldSeen: inputFeatures:
          if inputFeatures != [ ] then
            ...
            in [ feature ] ++ (expandFeaturesNoCycle seen
